...
- 💼 Software Engineering - DevOps Engineer @ Disney
- 🌱 I'm focused on growing my AWS skills and learning Terraform and automation

###  ⬇️ Check Out My Other Projects ⬇️
| Project | Description |
| ----------- | ----------- |
| [Earnest Gumiho](https://www.gumihollc.com) | Static website deployed to AWS Amplify, built with AI Assistance, and used client constraints to configure their DNS routing |
